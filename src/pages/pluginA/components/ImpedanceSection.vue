...
<!-- 五、阻抗 -->
      ...
      <div v-if="sections.impedance" style="padding:0">
        <el-table :data="impRows" size="small" border style="width:100%">
          ...
          <el-table-column label="公差(ohm)"><template #default="{ row }"><el-input-number :controls="false" v-model="row.impOhmTol" :min="0" :max="200" :precision="2" size="large" style="width:100%" /></template></el-table-column>
