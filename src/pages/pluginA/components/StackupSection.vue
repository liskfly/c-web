...
<!-- 四、叠层 -->
      ...
      <div v-if="sections.stackup" style="padding:0">
        ...
        <el-table :data="stackupRows" size="small" border style="width:100%">
          ...
          <el-table-column label="铜厚(mil)"><template #default="{ row }"><el-input v-model="row.copperThickness" size="large" :disabled="row.material!=='CU'" style="width:100%" /></template></el-table-column>
